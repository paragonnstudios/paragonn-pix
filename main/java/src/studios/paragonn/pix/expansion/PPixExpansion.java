package studios.paragonn.pix.expansion;
...
public class PPixExpansion extends PlaceholderExpansion {
	
	private static List<DonorInfo> topDonors;

	@Override
	public String getAuthor() {
		return String.join(", ", PPix.getInstance().getDescription().getAuthors());
	}
	...
	public String getVersion() {
		return PPix.getInstance().getDescription().getVersion();
	}
	...
	public static void updateTopDonorsCache(List<DonorInfo> topDonors) {
		PPixExpansion.topDonors = topDonors;
	}
