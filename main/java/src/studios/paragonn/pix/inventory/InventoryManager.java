...
public class InventoryManager {
	...
	public static void createMenuInventory(PPix ap) {
	...
	public static Object[] getProductMenuAndSlot(String product) {
		for (String menu : PRODUCTS.keySet()) {
			for (java.util.Map.Entry<Integer, OrderProduct> entry : PRODUCTS.get(menu).entrySet()) {
				if (entry.getValue().getProduct().equalsIgnoreCase(product)) {
					return new Object[] { menu, entry.getKey() };
				}
			}
		}
		return null;
	...
	public static void updateMapMeta(PPix ap, MapMeta meta, Player p, OrderProduct op) {
