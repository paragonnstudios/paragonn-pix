package studios.paragonn.pix.mercadopago;
...
public class MercadoPagoAPI {
	...
	public static PixData createPixPayment(
			PPix ap, Player p, OrderProduct product, float price
			) throws Exception {	
		...
		if (statusCode != 201) {
			Bukkit.getConsoleSender().sendMessage("\u00a7b[PPix] \u00a7cErro ao validar PIX:\n"
	...
	public static PaymentInfo getPayment(PPix ap, String id) {
		String responseMP = "";
		try {
	...
	public static boolean cancelPayment(PPix ap, String paymentId) throws Exception {
